...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Menu /</span> Drinks</h4>

<!-- Accordion -->
<h5 class="mt-4">Shakes</h5>
<div class="row">
