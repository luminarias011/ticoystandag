            ...
            <div class="card accordion-item active mb-3">
                <h2 class="accordion-header" id="headingOne">
                    <button type="button" class="accordion-button" data-bs-toggle="collapse" data-bs-target="#accordionOne"
                        ...
                        <span class=""><i class="bx bxs-book-content pe-2 mt-n1 link-primary"></i>MANAGE</span>
                    </button>
                </h2>
                        ...
                        <div class="row mb-3 mt-1" style="padding-left: 6px">
                            <div class="col-12">
                                <button class="btn btn-info btn-md" style="min-width: 280px" type="button" data-bs-toggle="modal"
                                    ...
                                    <span class=""><i class="bx bx-bookmark-alt-plus pe-2 mt-n1"></i>POST CONTENT</span>
                                </button>
                            </div>
                        </div>
                        <div class="row mb-3" style="padding-left: 6px">
                            <div class="col-12">
                                {{-- <button class="btn btn-danger btn-md" onclick="window.location.href='{{ route('manage') }}'"
                                    style="min-width: 280px" type="button">
                                    <span class=""><i class="bx bxs-cog pe-2 mt-n1"></i>MANAGE BOOKS</span>
                                </button> --}}
                                <button class="btn btn-danger btn-md" onclick="window.location.href=''" style="min-width: 280px" type="button">
                                    <span class=""><i class="bx bxs-cog pe-2 mt-n1"></i>SHOW ALL CONTENTS</span>
                                </button>
                            </div>
                        </div>
                        {{-- * --}}
            ...
            <div class="card accordion-item mb-3">
                ...
                <div id="accordionTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="row mb-3" style="padding-left: 6px">
                            <div class="col-12">
                                {{-- <button class="btn btn-info btn-md" onclick="window.location.href='{{ route('category') }}'"
                                    style="min-width: 280px" type="button">
                                    <span class=""><i class="bx bx-info-circle pe-2 mt-n1"></i>SEE EACH STATUS</span>
                                </button> --}}
                                <button class="btn btn-info btn-md" onclick="window.location.href=''" style="min-width: 280px"
                                    type="button">
                                    <span class=""><i class="bx bx-info-circle pe-2 mt-n1"></i>SEE EACH STATUS</span>
                                </button>
                            </div>
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="row mb-3" style="padding-left: 6px">
                            <div class="col-12">
                                ...
                                <button class="btn btn-danger btn-md" onclick="window.location.href=''" style="min-width: 280px"
                                    type="button">
                                    <span class=""><i class="bx bxs-cog pe-2 mt-n1"></i>MANAGE BOOKS</span>
                                </button>
                            </div>
