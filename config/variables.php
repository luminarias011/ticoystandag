<?php
  ...
  return [
    ...
    "templateName" => "Ticoy's",
    "templateDescription" => "Ticoy's Kan-anan & Snacks",
    "templateKeyword" => "Mia uuuyyy!",
    ...
    "productPage" => "https://www.facebook.com/profile.php?id=61550712278986",
